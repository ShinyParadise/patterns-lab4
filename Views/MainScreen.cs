...
namespace Lab4_Library
{
    public partial class MainScreen : Form
    {
        ...
        private void IssueBookBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Чтобы взять книгу, выберите свою карточку в меню слева, а книгу справа");
                return;
            }
            var sub = viewModel.GetSubs[subIndex];
        ...
        private void ReturnBookBtn_Click(object sender, EventArgs e)
        {
            ...
            if (subIndex == -1 || bookIndex == -1)
            {
                MessageBox.Show("Чтобы вернуть книгу, выберите свою карточку в меню слева и книгу в меню посередине");
                return;
            }
            var sub = viewModel.GetSubs[subIndex];
